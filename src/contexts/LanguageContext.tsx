...
export const translations = {
  nl: {
    ...
    // Services Page
    'services.hero.title': 'Finance Optimalisatie & BTW-compliance Diensten',
    'services.hero.subtitle': 'Professionele BTW-compliance en finance optimalisatie voor multinationals in België. 50% tijdsbesparing, 100% compliance garantie.',
    'services.hero.cta1': 'Gratis kennismaking',
    'services.hero.cta2': 'Meer informatie',
    
    'services.benefits.title': 'Waarom kiezen voor Alventis?',
    'services.benefits.subtitle': 'Bewezen resultaten voor internationale bedrijven',
    'services.benefits.efficiency.title': '50% Tijdsbesparing',
    'services.benefits.efficiency.description': 'Automatisering van repetitieve finance processen',
    'services.benefits.compliance.title': '100% Compliance',
    'services.benefits.compliance.description': 'Volledige naleving van Belgische btw-regelgeving',
    'services.benefits.time.title': '3 Maanden Implementatie',
    'services.benefits.time.description': 'Snelle implementatie zonder verstoring bedrijfsvoering',
    'services.benefits.accuracy.title': '99% Nauwkeurigheid',
    'services.benefits.accuracy.description': 'Gestructureerde processen elimineren fouten',
    
    'services.packages.title': 'Onze Dienstverlening',
    'services.packages.subtitle': 'Kies het pakket dat bij uw bedrijf past',
    'services.packages.popular': 'Meest Gekozen',
    'services.packages.basic.title': 'BTW Compliance',
    'services.packages.basic.description': 'Basis btw-compliance voor kleinere organisaties',
    'services.packages.basic.features.0': 'Btw-analyse en compliance check',
    'services.packages.basic.features.1': 'Implementatie van btw-processen',
    'services.packages.basic.features.2': 'Kwartaalrapportage',
    'services.packages.basic.features.3': 'Telefoon en email support',
    'services.packages.basic.features.4': 'Basis training team',
    'services.packages.basic.cta': 'Start met BTW Compliance',
    'services.packages.premium.title': 'Finance Optimalisatie',
    'services.packages.premium.description': 'Complete finance transformatie voor middelgrote bedrijven',
    'services.packages.premium.features.0': 'Volledige procesanalyse en optimalisatie',
    'services.packages.premium.features.1': 'Digitalisering finance processen',
    'services.packages.premium.features.2': 'Implementatie audit-ready rapportage',
    'services.packages.premium.features.3': 'Maandelijkse strategische reviews',
    'services.packages.premium.features.4': 'Uitgebreide team training',
    'services.packages.premium.features.5': 'Priority support 24/7',
    'services.packages.premium.cta': 'Optimaliseer Finance Processen',
    'services.packages.enterprise.title': 'Enterprise Transformatie',
    'services.packages.enterprise.description': 'Complete finance transformatie voor multinationals',
    'services.packages.enterprise.features.0': 'Multi-country compliance strategie',
    'services.packages.enterprise.features.1': 'Custom finance systeem integraties',
    'services.packages.enterprise.features.2': 'Change management begeleiding',
    'services.packages.enterprise.features.3': 'Dedicated project manager',
    'services.packages.enterprise.features.4': 'Executive dashboards en KPI tracking',
    'services.packages.enterprise.features.5': 'Onbeperkte consultancy uren',
    'services.packages.enterprise.cta': 'Plan Enterprise Transformatie',
    
    'services.process.title': 'Onze Aanpak',
    'services.process.subtitle': 'Een bewezen 5-stappen methode voor duurzaam succes',
    'services.process.step1.title': 'Intake & Analyse',
    'services.process.step1.description': 'Grondige analyse van huidige processen en knelpunten',
    'services.process.step2.title': 'Strategie & Planning',
    'services.process.step2.description': 'Ontwikkeling van maatwerkstrategie en implementatieplan',
    'services.process.step3.title': 'Implementatie',
    'services.process.step3.description': 'Gefaseerde uitrol met minimale bedrijfsverstoring',
    'services.process.step4.title': 'Training & Optimalisatie',
    'services.process.step4.description': 'Teamtraining en fine-tuning van nieuwe processen',
    'services.process.step5.title': 'Monitoring & Support',
    'services.process.step5.description': 'Continue ondersteuning en performantie monitoring',
    
    'services.kpis.title': 'Bewezen Resultaten',
    'services.kpis.subtitle': 'Meetbare verbeteringen binnen 3 maanden',
    'services.kpis.time': 'Tijdsbesparing',
    'services.kpis.compliance': 'Compliance Rate',
    'services.kpis.implementation': 'Implementatietijd',
    'services.kpis.months': 'maanden',
    'services.kpis.satisfaction': 'Klanttevredenheid',
    'services.kpis.reduction': 'Foutreductie',
    
    'services.faq.title': 'Veelgestelde Vragen',
    'services.faq.subtitle': 'Antwoorden op de meest gestelde vragen',
    'services.faq.q1.question': 'Hoe kan Alventis mijn btw-compliance verbeteren?',
    'services.faq.q1.answer': 'Wij analyseren je huidige btw-processen en implementeren gestructureerde workflows die voldoen aan Belgische en Europese regelgeving.',
    'services.faq.q2.question': 'Wat is het verschil tussen finance optimalisatie en gewone boekhouding?',
    'services.faq.q2.answer': 'Finance optimalisatie gaat verder dan boekhouding. Wij kijken naar je complete finance processen en automatiseren repetitieve taken.',
    'services.faq.q3.question': 'Hoe lang duurt een finance transformatie?',
    'services.faq.q3.answer': 'Een standaard optimalisatie traject duurt 3-6 maanden. We beginnen met een grondige analyse en bouwen gefaseerd op.',
    'services.faq.q4.question': 'Werken jullie ook met internationale multinationals?',
    'services.faq.q4.answer': 'Ja, dat is onze specialiteit. Met 10+ jaar ervaring begrijpen we de complexiteit van multi-country finance structuren.',
    'services.faq.q5.question': 'Wat zijn de kosten voor jullie dienstverlening?',
    'services.faq.q5.answer': 'Onze tarieven zijn afhankelijk van de scope en complexiteit. We bieden altijd een gratis kennismakingsgesprek aan.',
    'services.faq.q6.question': 'Krijg ik ondersteuning na de implementatie?',
    'services.faq.q6.answer': 'Ja, alle pakketten bevatten follow-up ondersteuning. We monitoren de resultaten en optimaliseren waar nodig.',
    'services.faq.q7.question': 'Kunnen jullie helpen met internationale btw-structuren?',
    'services.faq.q7.answer': 'Absoluut. Onze expertise in internationale btw-compliance helpt multinationals met complexe cross-border structuren.',
    
    'services.finalCta.title': 'Klaar om uw finance processen te optimaliseren?',
    'services.finalCta.subtitle': 'Plan een gratis kennismakingsgesprek en ontdek hoe wij uw finance afdeling kunnen transformeren.',
    'services.finalCta.button': 'Plan Gratis Kennismaking',
  ...
  en: {
    ...
    'services.hero.title': 'Finance Optimization & VAT Compliance Services',
    'services.hero.subtitle': 'Professional VAT compliance and finance optimization for multinationals in Belgium. 50% time savings, 100% compliance guarantee.',
    'services.hero.cta1': 'Free Consultation',
    'services.hero.cta2': 'Learn More',
    'services.benefits.title': 'Why Choose Alventis?',
    'services.benefits.subtitle': 'Proven results for international companies',
    'services.benefits.efficiency.title': '50% Time Savings',
    'services.benefits.efficiency.description': 'Automation of repetitive finance processes',
    'services.benefits.compliance.title': '100% Compliance',  
    'services.benefits.compliance.description': 'Full compliance with Belgian VAT regulations',
    'services.benefits.time.title': '3 Month Implementation',
    'services.benefits.time.description': 'Fast implementation without business disruption',
    'services.benefits.accuracy.title': '99% Accuracy',
    'services.benefits.accuracy.description': 'Structured processes eliminate errors',
    'services.packages.title': 'Our Services',
    'services.packages.subtitle': 'Choose the package that fits your company',
    'services.packages.popular': 'Most Popular',
    'services.packages.basic.title': 'VAT Compliance',
    'services.packages.basic.description': 'Basic VAT compliance for smaller organizations',
    'services.packages.basic.features.0': 'VAT analysis and compliance check',
    'services.packages.basic.features.1': 'Implementation of VAT processes',
    'services.packages.basic.features.2': 'Quarterly reporting',
    'services.packages.basic.features.3': 'Phone and email support',
    'services.packages.basic.features.4': 'Basic team training',
    'services.packages.basic.cta': 'Start VAT Compliance',
    'services.packages.premium.title': 'Finance Optimization',
    'services.packages.premium.description': 'Complete finance transformation for mid-size companies',
    'services.packages.premium.features.0': 'Full process analysis and optimization',
    'services.packages.premium.features.1': 'Digitalization of finance processes',
    'services.packages.premium.features.2': 'Implementation of audit-ready reporting',
    'services.packages.premium.features.3': 'Monthly strategic reviews',
    'services.packages.premium.features.4': 'Extensive team training',
    'services.packages.premium.features.5': 'Priority support 24/7',
    'services.packages.premium.cta': 'Optimize Finance Processes',
    'services.packages.enterprise.title': 'Enterprise Transformation',
    'services.packages.enterprise.description': 'Complete finance transformation for multinationals',
    'services.packages.enterprise.features.0': 'Multi-country compliance strategy',
    'services.packages.enterprise.features.1': 'Custom finance system integrations',
    'services.packages.enterprise.features.2': 'Change management guidance',
    'services.packages.enterprise.features.3': 'Dedicated project manager',
    'services.packages.enterprise.features.4': 'Executive dashboards and KPI tracking',
    'services.packages.enterprise.features.5': 'Unlimited consultancy hours',
    'services.packages.enterprise.cta': 'Plan Enterprise Transformation',
    'services.process.title': 'Our Approach',
    'services.process.subtitle': 'A proven 5-step method for sustainable success',
    'services.process.step1.title': 'Intake & Analysis',
    'services.process.step1.description': 'Thorough analysis of current processes and bottlenecks',
    'services.process.step2.title': 'Strategy & Planning',
    'services.process.step2.description': 'Development of tailored strategy and implementation plan',
    'services.process.step3.title': 'Implementation',
    'services.process.step3.description': 'Phased rollout with minimal business disruption',
    'services.process.step4.title': 'Training & Optimization',
    'services.process.step4.description': 'Team training and fine-tuning of new processes',
    'services.process.step5.title': 'Monitoring & Support',
    'services.process.step5.description': 'Continuous support and performance monitoring',
    'services.kpis.title': 'Proven Results',
    'services.kpis.subtitle': 'Measurable improvements within 3 months',
    'services.kpis.time': 'Time Savings',
    'services.kpis.compliance': 'Compliance Rate',
    'services.kpis.implementation': 'Implementation Time',
    'services.kpis.months': 'months',
    'services.kpis.satisfaction': 'Client Satisfaction',
    'services.kpis.reduction': 'Error Reduction',
    'services.faq.title': 'Frequently Asked Questions',
    'services.faq.subtitle': 'Answers to the most common questions',
    'services.faq.q1.question': 'How can Alventis improve my VAT compliance?',
    'services.faq.q1.answer': 'We analyze your current VAT processes and implement structured workflows that comply with Belgian and European regulations.',
    'services.faq.q2.question': 'What is the difference between finance optimization and regular accounting?',
    'services.faq.q2.answer': 'Finance optimization goes beyond accounting. We look at your complete finance processes and automate repetitive tasks.',
    'services.faq.q3.question': 'How long does a finance transformation take?',
    'services.faq.q3.answer': 'A standard optimization project takes 3-6 months. We start with thorough analysis and build up in phases.',
    'services.faq.q4.question': 'Do you work with international multinationals?',
    'services.faq.q4.answer': 'Yes, that is our specialty. With 10+ years of experience we understand the complexity of multi-country finance structures.',
    'services.faq.q5.question': 'What are the costs for your services?',
    'services.faq.q5.answer': 'Our rates depend on scope and complexity. We always offer a free consultation meeting.',
    'services.faq.q6.question': 'Do I get support after implementation?',
    'services.faq.q6.answer': 'Yes, all packages include follow-up support. We monitor results and optimize where needed.',
    'services.faq.q7.question': 'Can you help with international VAT structures?',
    'services.faq.q7.answer': 'Absolutely. Our expertise in international VAT compliance helps multinationals with complex cross-border structures.',
    'services.finalCta.title': 'Ready to optimize your finance processes?',
    'services.finalCta.subtitle': 'Schedule a free consultation and discover how we can transform your finance department.',
    'services.finalCta.button': 'Schedule Free Consultation',
